document.addEventListener('DOMContentLoaded',()=>{
  ...
  let started=false,raf=0,userPaused=false,songDuration=0,nazarShown=false,revealTimer=0,envelopeOpened=false;
  ...
  // Step 1: tapping the wax seal opens the envelope and reveals a short, heartfelt
  // note from the couple — the celebrations themselves don't begin until the guest
  // is ready and taps "Begin the Celebrations".
  ...
  // Step 2: guest taps "Begin the Celebrations" — this fresh tap is what lets audio
  // autoplay reliably on iOS Safari and Android Chrome.
